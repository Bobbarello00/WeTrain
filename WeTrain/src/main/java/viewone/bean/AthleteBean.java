...
public class AthleteBean extends UserBean{
    ...
    public AthleteBean(String username, String name, String surname, String fc, LocalDate birth, String usrType, char gender, String email, String password, String cardNumber, YearMonth cardExpirationDate) throws ExpiredCardException {
